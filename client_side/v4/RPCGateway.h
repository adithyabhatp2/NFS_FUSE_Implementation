...
public:
    ...
    int xmp_release(const char *path, struct fuse_file_info *fi, int num);
    int xmp_fsync(const char *path, int isdatasync, struct fuse_file_info *fi, int num);
