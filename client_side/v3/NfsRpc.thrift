...
service NfsRpc {
    ...
    i32 xmp_release(1:string tpath, 2:thrift_fuse_file_info tfi, 3:i32 num);
    thrift_fsync_reply xmp_fsync(1:string tpath, 2:i32 isdatasync, 3:thrift_fuse_file_info tfi, 4:i32 num);
}
